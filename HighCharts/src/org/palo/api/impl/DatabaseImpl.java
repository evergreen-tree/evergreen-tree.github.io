 ...
 * @author Arnd Houben
 * @author Stepan Rutz
 * @version $Id: DatabaseImpl.java,v 1.95 2008/05/13 10:00:44 ArndHouben Exp $
 */
class DatabaseImpl extends AbstractPaloObject implements Database {
...
//		return (Dimension[])dims.toArray(new Dimension[dims.size()]);
	...
	public final String parseRule(Cube cube, String definition, String functions) {
		//if(functions!=null)
        //	System.err.println("Database - parseRule: functions are currently not supported!!");
        try {
