 ...
 * 
 * @author Arnd Houben
 * @version $Id: ConnectionImpl.java,v 1.89 2008/05/13 10:00:44 ArndHouben Exp $
 */
class ConnectionImpl implements Connection, ServerListener {
...
//		loadDatabaseInfos();		
	...
	public final Database addDatabase(String name) {
		try {
			DatabaseInfo dbInfo = dbLoader.create(name);
...
//	}
    ...
    final DbConnection getConnectionInternal() {
		return dbConnection;
	}
