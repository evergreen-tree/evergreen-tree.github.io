 ...
 * @author Arnd Houben
 * @author Stepan Rutz
 * @version $Id: DimensionImpl.java,v 1.100 2008/05/09 11:12:05 ArndHouben Exp $
 */
...
//	public final Subset2 addSubset2(String name, boolean global) {
//		try {
//			Subset2StorageHandler subsetHandler = ((DatabaseImpl) database)
//					.getSubsetHandler();
//			return subsetHandler.newSubset(name, this, global);
//		} catch (PaloIOException pio) {
//			throw new PaloAPIException("Could not create subset '" + name
//					+ "'!", pio);
//		}
//	}
//	
//	public final Subset2 addSubset2(String id, String name, boolean global) {
//		try {
//			Subset2StorageHandler subsetHandler = ((DatabaseImpl) database)
//					.getSubsetHandler();
//			return subsetHandler.newSubset(id, name, this, global);
//		} catch (PaloIOException pio) {
//			throw new PaloAPIException("Could not create subset '" + name
//					+ "'!", pio);
//		}
//	}
//	
//	public final void removeSubset(Subset2 subset, boolean global) {
//		Subset2StorageHandler subsetHandler = 
//			((DatabaseImpl)database).getSubsetHandler();
//		try {
//			subsetHandler.delete(subset, global);
//		} catch(PaloIOException pio) {
//			throw new PaloAPIException("Deleting subset '"+subset.getName()+"' failed!", pio);
//		}
////		return subsetStorageHandler.remove(subset);
//	}
//	
//	public final Subset2[] getSubsets2() {
//		if(isSystemDimension() || isAttributeDimension())
//			return new Subset2[0];
//		
//		DatabaseImpl dbImpl = (DatabaseImpl)database;
//		Subset2StorageHandler subsetHandler = dbImpl.getSubsetHandler();
//
////		//first check if we have to transform old subsets:
////    	if(subsetHandler.oldSubsetsExist()) {
////    		//transform them:
////    		Subset[] oldSubsets;
////			try {
////				oldSubsets = dbImpl.getSubsetStorageHandler().getSubsets(this);
////				subsetHandler.transformOldSubsets(oldSubsets);
////			} catch (PaloPersistenceException e) {
////				System.err.println("Dimension#getSubsets2(): Failed to load old subsets!");
////			} catch (PaloIOException e) {
//////				e.printStackTrace();
////				System.err.println("Dimension#getSubsets2(): Failed to transform the following subsets:");
////				String[] names = (String[])e.getData();
...
////
////		try {						
////			return subsetHandler.loadAll(this);
////		}catch(PaloIOException pio) {
////			throw new PaloAPIException("Failed to load subsets for this dimension!",pio);
////		}
//	}
