...
public class XMLAConnection implements DbConnection {
	...
	public DatabaseInfo addDatabase(String database) {
...
//		return cubeInfo;
	...
	private final CellInfo [] performCopy(ArrayList <CoordinateStorage> allCoords, DimensionInfo [] origDims, CubeInfo cube) {
...
//		return elementInfo;
	...
	public RuleInfo createRule(CubeInfo cube, String definition, String externalIdentifier, boolean useIt, String comment) {
